...
<center>
   ...
   $results = mysqli_query($db, "SELECT * FROM data WHERE id = $id");
        ...
        if ($name == "" || $occupation == "") {
          ...
          $black = imagecolorallocate($createimage, 255, 255, 255);
          ...
          $filename = "upload/$im"; 
          $str=imagecreatefrompng( $filename);
          imagecopy($createimage,$str, 150, 520 , 00, 00, 400, 400);
 ...
 ?>
        ...
        <a href="<?php echo $output; ?>" download class="btn btn-success">Download </a> 
        <br><br>
<?php 
        }}
     ...
     ?>
      ...
      <footer>  
          <center><p>Built with &#10084; by <a href="joel-new.netlify.app">juhd itsolution</a></p></center>
      </footer>
